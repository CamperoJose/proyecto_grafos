...
class NorwestMin {
  ResultadoNorwestMin calcNorwestMin(List<List<int>> matrizOriginal, List<int> disponibilidad, List<int> demanda,
      ...
      if(men[0]>=0)
        {
          ...
          return ResultadoNorwestMin(matrizResultado, sumatoria);
        }else{
    ...
    return ResultadoNorwestMin(nuevaMatriz, sumatoria);
  }
...
class ResultadoNorwestMin {
  List<List<int>> matriz;
  int sumatoria;

  ResultadoNorwestMin(this.matriz, this.sumatoria);
}
