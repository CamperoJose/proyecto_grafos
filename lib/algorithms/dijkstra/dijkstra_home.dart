...
import 'package:proyecto_grafos/algorithms/dijkstra/dijkstra_appbar.dart';
import 'package:proyecto_grafos/algorithms/kruskal/botton_app_bar.dart';
...
class HomeDijkstra extends StatefulWidget {
  const HomeDijkstra({super.key});
  @override
  State<HomeDijkstra> createState() => _HomeState();
}

class _HomeState extends State<HomeDijkstra> {
  int modo = -1;
                                              ...
                                              //alerta de error:
                                                                    ...
                                                                    builder: (BuildContext context) {
                                                                      return MyAlertErrorDialog(
                                                                        ...
                                                                        content: 'En el algoritmo de Johnson no se permiten bucles',
                                                                      );
                                                                    },
                                                                  );
                              ...
                              return AlertDialog(
                                ...
                                actions: <Widget>[
                                  ElevatedButton(
                                    ...
                                    onPressed: () {
                                      setState(() {
                                        int pos = values.indexWhere((element) =>
                                            element == objE.mensaje);
                                        values[pos] =
