...
import 'package:proyecto_grafos/algorithms/asignaci%C3%B3n/app_bar_asignacion.dart';
...
class HomeAsignacion extends StatefulWidget {
  const HomeAsignacion({super.key});
  @override
  State<HomeAsignacion> createState() => _HomeState();
}

class _HomeState extends State<HomeAsignacion> {
  int modo = -1;
