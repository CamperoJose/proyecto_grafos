...
import 'package:proyecto_grafos/algorithms/jhonson/jhonson_appbar.dart';
...
class HomeJhonson extends StatefulWidget {
  const HomeJhonson({super.key});
  @override
  State<HomeJhonson> createState() => _HomeState();
}

class _HomeState extends State<HomeJhonson> {
  int modo = -1;
